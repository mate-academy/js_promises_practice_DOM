...
- The `secondPromise` should be:
  ...
  - never **rejected**
- The `secondPromise` should be **resolved** with a message `Third promise was resolved` only after both `left` and `right` clicks happened
...
1. Replace `<your_account>` with your Github username in the link
    - [DEMO LINK](https://anastasia-kravchuk.github.io/js_promises_practice_DOM/)
